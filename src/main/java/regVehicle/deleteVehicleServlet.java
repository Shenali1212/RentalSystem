...
public class deleteVehicleServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		isTrue = RegvehicleDBUtil.deleteVehicle(id);
		...
		List<Regvehicle> RegvehicleDetails = RegvehicleDBUtil.getVheicleDetails(id);
		request.setAttribute("RegvehicleDetails", RegvehicleDetails);
		
		RequestDispatcher dispatcher = request.getRequestDispatcher("displayVehicleDetails.jsp");
