...
<head>
    <meta charset="UTF-8">
    <title>Delete Inquiry - Vehicle Rental</title>
        ...
        <div class="inquiry-box">
            ...
            <form action="delete" method="post">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="subject" name="inquirysubject" value="<%= subject%>" readonly>
                </div>
                <div class="input-group">
                    <label for="message">Message</label>
                    <textarea id="message" name="inquirydetails" readonly><%= message %></textarea> 
                </div>
                <div class="input-group">
                ...
                <div class="input-group">
                    <input type="submit" name = "delete" value = "Delete Inquiry"><br>
                </div>
            </form>
        </div>
    </div>
