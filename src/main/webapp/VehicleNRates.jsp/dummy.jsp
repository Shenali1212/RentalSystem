  ...
  <!-- Top Navigation Bar (with logo and Login/Register) -->
    ...
    <nav class="navbar">
        ...
        <ul class="nav-links">                                                        
            ...
            <li><a href="vehiclesRates.jsp">Vehicles and Rates</a></li>
    ...
    <form action = "find" method = "post">
		...
		<input type="submit" value="Search Ur Rents">
    ...
    <button name = "admin"  value = "go"> Go to admin </button>
	</form>
	
	<form action ="search" method = "post">
    <button name = "aa"  value = "s"> s </button>
	</form>
