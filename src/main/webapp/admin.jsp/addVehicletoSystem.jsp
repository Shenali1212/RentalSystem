...
<body>
    ...
    %>
	 ...
	 <div class="confirmation-container">
        ...
        <p>Are you sure you want to add this item to system?.</p>

        <form action="addSysVeh" method="post">
            <!-- Hidden input to pass ID or other relevant information -->
            <input type="hidden" name="vehId" value="<%=vehId %>">
            
             <input type="hidden" name="makeModel" value="<%=makeModel%>">
             ...
             <input type="hidden" name="rentalPricing" value="<%=rentalPricing%>">

            <!-- Buttons for confirmation and cancel -->
            <button type="submit" class="btn-delete">Add</button>
